...
class ChatRoutes {
    ...
    config() {
        ...
        this.router.get('/:nrc/:noTrabajador', chatController_1.default.getOne);
        this.router.get('/:nrc/:id_equipo/:noTrabajador', chatController_1.default.getOneEq);
        ...
        this.router.delete('/:nrc/:noTrabajador', chatController_1.default.deleteChatCur);
