...
class studCourseRoutes {
    ...
    config() {
        this.router.get('/', studCourseController_1.default.lista);
        ...
        this.router.get('/:matricula', studCourseController_1.default.getEstudianteCurso);
        ...
        this.router.post('/:nrc', studCourseController_1.default.deleteCursoEs);
    }
}
